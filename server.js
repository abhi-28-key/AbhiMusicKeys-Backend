      ...
      <div style="font-family:Segoe UI, Roboto, Helvetica, Arial, sans-serif; background:#0f172a; padding:24px; color:#e2e8f0;">
        <div style="max-width:640px; margin:0 auto; background:linear-gradient(135deg,#1e293b,#111827); border:1px solid #334155; border-radius:16px; overflow:hidden;">
          ...
          <div style="padding:28px;">
            ...
            <a href="https://abhimusickeys.in/" target="_blank" style="display:inline-block; background:#8b5cf6; color:#fff; text-decoration:none; padding:10px 16px; border-radius:10px; font-weight:700;">Start Learning</a>
          </div>
          ...
          <div style="font-family:Segoe UI, Roboto, Helvetica, Arial, sans-serif; background:#0f172a; padding:24px; color:#e2e8f0;">
            <div style="max-width:640px; margin:0 auto; background:linear-gradient(135deg,#1e293b,#111827); border:1px solid #334155; border-radius:16px; overflow:hidden;">
              ...
              <div style="padding:28px;">
                ...
                <a href="https://abhimusickeys.in/" target="_blank" style="display:inline-block; background:#3b82f6; color:#fff; text-decoration:none; padding:10px 16px; border-radius:10px; font-weight:700;">Go to Dashboard</a>
              </div>
              <div style="padding:16px 24px; border-top:1px solid #334155; color:#94a3b8; font-size:12px;">© ${new Date().getFullYear()} AbhiMusicKeys</div>
            </div>
          </div>`;
